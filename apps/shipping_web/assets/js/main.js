...
var _user$project$Main$date = function () {
...
var _user$project$Main$phoenixHostPortUrl = 'http://localhost:4000';
var _user$project$Main$cargoesUrl = A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$phoenixHostPortUrl, '/cargoes');
var _user$project$Main$phoenixWSUrl = A2(
	_elm_lang$core$Basics_ops['++'],
	'ws:',
	A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$phoenixHostPortUrl, '/socket/websocket'));
var _user$project$Main$viewHandler = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('HANDLER STUFF'),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$viewHandlingEvent = function (handlingEvent) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(handlingEvent.voyage),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(handlingEvent.location),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(_mgold$elm_date_format$Date_Format$format, '%Y-%m-%d %H:%M:%S', handlingEvent.completion_time)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(handlingEvent.event_type),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$viewHandlingEventTable = function (handlingEventList) {
	return A2(
		_elm_lang$html$Html$table,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('w3-table w3-striped w3-border'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Voyage No'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Main$viewHandlingEvent, handlingEventList.handling_events)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$controlClass = function (control) {
	return A2(_elm_lang$core$Basics_ops['++'], control, ' w3-bar-item w3-border w3-border-orange w3-hover-border-navy w3-round-large  w3-margin-right w3-deep-orange');
};
var _user$project$Main$trackingStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#eee'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'padding-left', _1: '48px'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'padding-right', _1: '48px'},
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Main$logoStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'display', _1: 'inline-block'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'width', _1: '257px'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'height', _1: '88px'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'background-size', _1: ' 257px 88px'},
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Main$initWebSocket = _fbonetti$elm_phoenix_socket$Phoenix_Socket$init(_user$project$Main$phoenixWSUrl);
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {user: a, customer: b, handler: c, phxSocket: d};
	});
var _user$project$Main$Customer = F2(
	function (a, b) {
		return {trackingId: a, handlingEventList: b};
	});
var _user$project$Main$initCustomer = A2(_user$project$Main$Customer, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing);
var _user$project$Main$Handler = function (a) {
	return {handlingEventList: a};
};
var _user$project$Main$initHandler = _user$project$Main$Handler(_elm_lang$core$Maybe$Nothing);
var _user$project$Main$HandlingEventList = function (a) {
	return {handling_events: a};
};
var _user$project$Main$HandlingEvent = F4(
	function (a, b, c, d) {
		return {event_type: a, completion_time: b, voyage: c, location: d};
	});
var _user$project$Main$handlingEventDecoder = A3(
	...
	A3(
		...
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'completion_time',
			_user$project$Main$date,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'type',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$HandlingEvent)))));
var _user$project$Main$handlingEventListDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'handling_events',
	_elm_lang$core$Json_Decode$list(_user$project$Main$handlingEventDecoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$HandlingEventList));
var _user$project$Main$trackingIdRequest = function (id) {
	return A2(
		_elm_lang$http$Http$get,
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Main$cargoesUrl,
			A2(_elm_lang$core$Basics_ops['++'], '?_format=json&tracking_id=', id)),
		_user$project$Main$handlingEventListDecoder);
};
var _user$project$Main$HandlerUser = {ctor: 'HandlerUser'};
var _user$project$Main$CustomerUser = {ctor: 'CustomerUser'};
var _user$project$Main$None = {ctor: 'None'};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A4(_user$project$Main$Model, _user$project$Main$None, _user$project$Main$initCustomer, _user$project$Main$initHandler, _user$project$Main$initWebSocket),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$HttpError = function (a) {
	return {ctor: 'HttpError', _0: a};
};
var _user$project$Main$JoinedChannel = function (a) {
...
var _user$project$Main$ReceivedHandlingEvents = function (a) {
	return {ctor: 'ReceivedHandlingEvents', _0: a};
};
var _user$project$Main$fetchCustomerTrackingId = function (trackingId) {
	var _p1 = trackingId;
	if (_p1.ctor === 'Just') {
		return A2(
			...
			function (result) {
				var _p2 = result;
				if (_p2.ctor === 'Ok') {
					return _user$project$Main$ReceivedHandlingEvents(_p2._0);
				} else {
					return _user$project$Main$HttpError(
						_elm_lang$core$Basics$toString(_p2._0));
				}
			},
			_user$project$Main$trackingIdRequest(_p1._0));
	} else {
		...
		switch (_p3.ctor) {
			...
			case 'Home':
				var channel = A2(
					...
					_elm_lang$core$Basics$always(
						_user$project$Main$JoinedChannel('handling_event:*')),
					_fbonetti$elm_phoenix_socket$Phoenix_Channel$init('handling_event:*'));
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{user: _user$project$Main$None, customer: _user$project$Main$initCustomer, handler: _user$project$Main$initHandler, phxSocket: phxSocket}),
			...
			case 'CustomerChosen':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{user: _user$project$Main$CustomerUser}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'HandlerChosen':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{user: _user$project$Main$HandlerUser}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'TrackingIdEntered':
				var customer = model.customer;
				var newCustomer = _elm_lang$core$Native_Utils.update(
					customer,
					{
						trackingId: _elm_lang$core$Maybe$Just(_p3._0),
						handlingEventList: _elm_lang$core$Maybe$Nothing
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'FindTrackingId':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$fetchCustomerTrackingId(model.customer.trackingId)
				};
			case 'ReceivedHandlingEvents':
				var customer = model.customer;
				var newCustomer = _elm_lang$core$Native_Utils.update(
					customer,
					{
						handlingEventList: _elm_lang$core$Maybe$Just(_p3._0)
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$FindTrackingId = {ctor: 'FindTrackingId'};
var _user$project$Main$TrackingIdEntered = function (a) {
	return {ctor: 'TrackingIdEntered', _0: a};
};
var _user$project$Main$viewCustomer = function (model) {
	var customer = model.customer;
	var _p6 = customer.handlingEventList;
	if (_p6.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('w3-bar w3-center w3-padding-48'),
				_1: {
					ctor: '::',
					_0: _user$project$Main$trackingStyle,
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('w3-bar-item'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'width', _1: '30em'},
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Tracking Number (e.g. ABC123, IJK456)'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$TrackingIdEntered),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('w3-bar-item w3-button w3-round-large w3-margin-left w3-deep-orange'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$FindTrackingId),
								_1: {ctor: '[]'}
							}
						},
						{
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('w3-col m3'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$viewHandlingEventTable(_p6._0),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('3-col m3'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Main$HandlerChosen = {ctor: 'HandlerChosen'};
var _user$project$Main$CustomerChosen = {ctor: 'CustomerChosen'};
var _user$project$Main$viewUserChoice = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('w3-bar w3-center w3-padding-48'),
		...
		_0: A2(
			_elm_lang$html$Html$button,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					_user$project$Main$controlClass('w3-button')),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$CustomerChosen),
					_1: {ctor: '[]'}
				}
			},
			{
		...
		_1: {
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$HandlerChosen),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Handler'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
...
var _user$project$Main$viewLogo = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('w3-bar  w3-border-bottom'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('w3-bar-item w3-left'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src('images/ddd_logo.png'),
					_1: {
						ctor: '::',
						_0: _user$project$Main$logoStyle,
						_1: {
							ctor: '::',
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('w3-container w3-center w3-padding-48'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$Main$viewLogo,
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$p,
				...
				_1: {
					...
					_0: function () {
						...
						switch (_p7.ctor) {
							case 'None':
								return _user$project$Main$viewUserChoice;
							case 'CustomerUser':
								return _user$project$Main$viewCustomer(model);
							default:
								return _user$project$Main$viewHandler(model);
						}
					}(),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$NoOpMsg = {ctor: 'NoOpMsg'};
